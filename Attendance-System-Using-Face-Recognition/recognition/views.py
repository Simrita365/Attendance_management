...
def send_file(request):
    return render(request,'recognition/file.html')
...
def send(request):
    if request.method=='POST':
        ...
        try:
            ...
            return render(request,'recognition/send.html',{'error_message': 'Sent email to %s'%email})
        except:
            return render(request,'recognition/send.html',{'error_message': 'Either the attachment is too big or corrupt'})

    return render(request,'recognition/send.html',{'error_message': 'Unable to send email. Please try again later'})